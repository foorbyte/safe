...
public class StatusCode {
	...
	public static final String FUNC_RECTO_VERSO = "700";
	public static final String FUNC_TYPE_PIECE = "600";

	public static final String FUNC_AUTH_FAIL = "901";
	public static final String FUNC_PAY_FAIL = "930";
	...
	public static final String FILE_EXTENSION = "947";
}
