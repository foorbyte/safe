...
public class StatusMessage {
	...
	public static final String FUNC_PAY_FAIL = "Impossible de continuer le paiement";
	...
	public static final String FILE_EXTENSION = "Opération impossible car le fichier n'a pas la bonne extension";
