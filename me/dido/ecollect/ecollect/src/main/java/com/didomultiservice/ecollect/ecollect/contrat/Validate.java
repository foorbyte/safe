...
public class Validate {
	...
	public static Validate CorrectTypedValue(Map<String, Object> listAverifier) {
		...
		public static <T,P> Response<P> validateObject(Request<T> request, Response<P> response, FunctionalError functionalError, Locale locale) throws Exception {
		boolean ostate = true;
	...
	public static <P,T> Response<P> validateList(Request<T> request, Response<P> response, FunctionalError functionalError, Locale locale) throws Exception {
		boolean ostate = true;
		response.setStatus(functionalError.REQUEST_FAIL("", locale));
		if (request == null) {
			response.setHasError(ostate);
