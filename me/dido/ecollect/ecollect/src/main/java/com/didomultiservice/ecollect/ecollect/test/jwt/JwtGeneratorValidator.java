package com.didomultiservice.ecollect.ecollect.test.jwt;
...
public class JwtGeneratorValidator {
    ...
    @Autowired
    UsersBusiness userService;

    private static final String SECRET = "mySuperSecretKeyWhichIsAtLeast32Chars!";
    ...
    private String createToken(Map<String, Object> claims, Authentication authentication) {
        ...
        return Jwts.builder()
                ...
                .signWith(SECRET_KEY) // Utilise la clé générée ici
                .compact();
    }
